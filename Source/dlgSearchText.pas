...
procedure TTextSearchDialog.cbSearchTextChange(Sender: TObject);
begin
  btnOk.Enabled:=cbSearchText.Text<>'';
end;

procedure TTextSearchDialog.FormActivate(Sender: TObject);
begin
  btnOk.Enabled:=cbSearchText.Text<>'';
end;

procedure TTextSearchDialog.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
